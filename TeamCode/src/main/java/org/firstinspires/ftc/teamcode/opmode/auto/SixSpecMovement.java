...
@Autonomous(name="SixSpecMovement")
public class SixSpecMovement extends LinearOpMode {
    ...
    private final Pose chamberPose = new Pose(31, 60, Math.toRadians(0)); // was 65
    private Claw claw;
    ...
    public void buildPaths() {
        ...
        placeSpecimen = new Path(new BezierLine(new Point(-2, 3, Point.CARTESIAN),
//                new Point(20, 10, Point.CARTESIAN),
//                new Point(0, 35, Point.CARTESIAN),
                new Point(21.5, yPlace, Point.CARTESIAN)));
        ...
        placeSpecimen2 = new Path(new BezierLine(new Point(5.5, 26, Point.CARTESIAN),
                new Point(23.5, yPlace, Point.CARTESIAN)));
        ...
        pickMore = new Path(new BezierLine(
                ...
                new Point(-4, 15, Point.CARTESIAN)
        ));
...
//                specArmClaw.setWristPosition(0.6);
            ...
            case 1:
                ...
                break;
            case 2:
                if (!follower.isBusy() && specArm.getPos() < -500) {
...
//                        }
            ...
            case 20:
                ...
                if(pathTimer.getElapsedTimeSeconds() > 0.5) {
                    ...
                    if (pathTimer.getElapsedTimeSeconds() > 0.7) {
                        yPlace = yPlace - 1.5;
                        placeSpecimen2 = new Path(new BezierLine(new Point(-4, 25, Point.CARTESIAN),
                                new Point(21.5, yPlace, Point.CARTESIAN)));
    ...
    public void runOpMode() {
        ...
        specArmClaw.setClawPosition(1);
        specArmClaw.setWristPosition(0.34); // 1.0

        claw.setClawPosition(0.9);
        claw.setWristPosition(0.856);
        claw.setArmPosition(0.77);
