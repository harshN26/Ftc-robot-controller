...
public class FollowerConstants {
    ...
    private static double xMovement = 65;
    private static double yMovement = 53;
    ...
    public static double holdPointTranslationalScaling = 0.1;

    // This is scales the heading error correction power when the Follower is holding a Point.
    public static double holdPointHeadingScaling = 0.05;
