...
@Autonomous(name="FinalBasketclone")
public class FinalBasketClone extends LinearOpMode {
    ...
    private final Pose sample3Pose = new Pose(23.5, 129.5, Math.toRadians(45)); // 128
    ...
    private int SLIDE_POSITION_EXTEND = 2900;

    private int ARM_POSITION_DOWN = 900;
